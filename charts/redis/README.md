...
It also fixes https://github.com/helm/charts/issues/7726 where a deployment `networking.k8s.io/v1beta1` can not be upgraded if `spec.selector` is not explicitly set.
