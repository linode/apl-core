...
crds="(appgw.ingress.k8s.io|cert-manager.io|externalsecrets.kubernetes-client.io|gatekeeper.sh|istio.io|jaegertracing.io|kiali.io|knative.dev|kubeapps.com|monitoring.coreos.com|operators.coreos.com|vault.banzaicloud.com)"
