...
kubectl get certificate -n istio-system -o name | while read cert; do kubectl annotate  $cert -n istio-system helm.sh/resource-policy='keep' deprecated=true; done
