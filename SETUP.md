...
# Demo topology: two teams with a full set of role-distinguishable accounts, so a fresh install
# reproduces the same nine users and two teams without any live scripting. See DEMO-TOPOLOGY.md
# for the full account table, the reasoning behind the naming, and everything this block does
# NOT cover -- the Gitea orgs/repos and Vikunja projects for these teams have no declarative
# path (confirmed live: teamConfig alone does not create a Gitea org) and still need the
# one-time script in that doc, run once after this install completes.
#
# lastName must never contain characters outside letters/spaces/hyphens/apostrophes -- Keycloak
# rejects anything else with error-person-name-invalid-character, and because the operator
# creates all pending users in one batch, a single bad value blocks every user in the batch, not
# just the offending one. Confirmed live: "Agent (bot)" broke all four not-yet-created users at
# once, including one with an unrelated, perfectly valid lastName.
users:
  - email: po-green@demo.apl
    firstName: Green
    lastName: PO
    isPlatformAdmin: false
    isTeamAdmin: false
    teams: ['green']
  - email: admin-green@demo.apl
    firstName: Green
    lastName: TeamAdmin
    isPlatformAdmin: false
    isTeamAdmin: true
    teams: ['green']
  - email: dev-green@demo.apl
    firstName: Green
    lastName: Developer
    isPlatformAdmin: false
    isTeamAdmin: false
    teams: ['green']
  - email: agent-green@demo.apl
    firstName: Green
    lastName: Agent
    isPlatformAdmin: false
    isTeamAdmin: false
    teams: ['green']
  - email: po-blue@demo.apl
    firstName: Blue
    lastName: PO
    isPlatformAdmin: false
    isTeamAdmin: false
    teams: ['blue']
  - email: admin-blue@demo.apl
    firstName: Blue
    lastName: TeamAdmin
    isPlatformAdmin: false
    isTeamAdmin: true
    teams: ['blue']
  - email: dev-blue@demo.apl
    firstName: Blue
    lastName: Developer
    isPlatformAdmin: false
    isTeamAdmin: false
    teams: ['blue']
  - email: agent-blue@demo.apl
    firstName: Blue
    lastName: Agent
    isPlatformAdmin: false
    isTeamAdmin: false
    teams: ['blue']
  - email: agent-platform@demo.apl
    firstName: Platform
    lastName: Agent
