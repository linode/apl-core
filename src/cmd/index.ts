...
import { module as defaultsModule } from './defaults'
import { module as destroyModule } from './destroy'
import { module as diffModule } from './diff'
import { module as diffTestModule } from './diff-test'
...
export { module as defaults } from './defaults'
export { module as destroy } from './destroy'
export { module as diff } from './diff'
export { module as diffTest } from './diff-test'
